...
public class EnglishGrammaticalRelations {
  ...
  public static final GrammaticalRelation CONJUNCT =
    new GrammaticalRelation(Language.English, "conj", "conjunct",
        ...
        new String[] { // remember conjunction can be left or right headed....
          ...
          "VP|S|SBAR|SBARQ < (CC|CONJP $-- !/^(``|-LRB-|PRN|PP|ADVP|RB)/ $+ !/^(?:PRN|``|''|-[LR]RB-|,|:|\\.)$/=target)",
          // non-parenthetical or comma in suitable phrase with conj then adverb to left
          "VP|S|SBAR|SBARQ < (CC|CONJP $-- !/^(``|-LRB-|PRN|PP|ADVP|RB)/ $+ (ADVP $+ !/^(?:PRN|``|''|-[LR]RB-|,|:|\\.)$/=target))",
          // content phrase to the right of a comma or a parenthetical
          "VP|S|SBAR|SBARQ < (CC|CONJP $-- !/^(``|-LRB-|PRN|PP|ADVP|RB)/) < (/^(?:PRN|``|''|-[LR]RB-|,|:|\\.)$/ $+ /^S$|^(?:A|N|V|PP|PRP|J|W|R)/=target)",

                // non-parenthetical or comma in suitable phrase with conjunction to left
                "ADJP|PP|QP|NP|ADVP|UCP|NX < (CC|CONJP $-- !/^(``|-LRB-|PRN)$/ $+ !/^(?:PRN|``|''|-[LR]RB-|,|:|\\.)$/=target)",
                // non-parenthetical or comma in suitable phrase with conj then adverb to left
                "ADJP|PP|NP|ADVP|UCP|NX < (CC|CONJP $-- !/^(``|-LRB-|PRN)$/ $+ (ADVP $+ !/^(?:PRN|``|''|-[LR]RB-|,|:|\\.)$/=target))",
                // content phrase to the right of a comma or a parenthetical
                "ADJP|PP|NP|ADVP|UCP|NX < (CC|CONJP $-- !/^(``|-LRB-|PRN)$/) < (/^(?:PRN|``|''|-[LR]RB-|,|:|\\.)$/ $+ /^S$|^(?:A|N|V|PP|PRP|J|W|R)/=target)",
          ...
          "NX < (CC|CONJP $- __) < (/^,$/ $- /^(A|N|V|PP|PRP|J|W|R|S)/=target)",
           ...
           "VP|S|SBAR|SBARQ|ADJP|PP|QP|NP|ADVP|UCP|NX < (CC $++ (CC|CONJP $+ !/^(?:PRN|``|''|-[LR]RB-|,|:|\\.)$/=target))",
        });
  ...
  public static final GrammaticalRelation DIRECT_OBJECT =
    new GrammaticalRelation(Language.English, "dobj", "direct object",
        ...
        new String[] {
          ...
          "SBARQ < (WHNP=target !< WRB) <+(SQ|SINV|S|VP) (VP !< NP|TO !< (S < (VP < TO)) !< (/^VB|AUXG?/ < " + copularWordRegex + " $++ (VP < VBN|VBD)) !<- PRT !<- (PP <: IN) $-- (NP !< /^-NONE-$/))",  // this pattern used to assume no empty NPs. Corrected.  If you adjust this pattern, also adjust the corresponding one for attr!
  ...
  public static final GrammaticalRelation CLAUSAL_COMPLEMENT =
    new GrammaticalRelation(Language.English, "ccomp", "clausal complement",
        ...
        new String[] { // note if you add more words in the pattern, be sure to add them in the ADV_CLAUSE_MODIFIER too!
          ...
          "VP < (SBAR=target < (SBAR < (S <+(S) VP) <, (IN|DT < /^(that|whether)$/)) < CC|CONJP)",
  ...
  public static final GrammaticalRelation DETERMINER =
    new GrammaticalRelation(Language.English, "det", "determiner",
        ...
        new String[] {
          "/^NP(?:-TMP|-ADV)?$/ < (DT=target !</both|either|neither/ !$- DT !$++ CC $++ /^(?:N[NXP]|CD|JJ|FW|ADJP)/)",
