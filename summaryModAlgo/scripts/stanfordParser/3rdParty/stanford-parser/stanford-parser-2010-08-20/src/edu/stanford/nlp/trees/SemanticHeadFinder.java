...
public class SemanticHeadFinder extends ModCollinsHeadFinder {
  ...
  public SemanticHeadFinder(TreebankLanguagePack tlp, boolean cop) {
    ...
    if (cop) {
      copulars.addAll(Arrays.asList(new String[]{"be", "being", "been", "am", "are", "is", "was", "were", "'m", "'re", "'s", "s", "seem", "seems", "seemed", "appear", "appears", "appeared", "stay", "stays", "stayed", "remain", "remains", "remained", "resemble", "resembles", "resembled", "become", "becomes", "became"}));
  ...
  private void ruleChanges() {
    ...
    nonTerminalInfo.put("NP", new String[][]{{"rightdis", "NN", "NNP", "NNPS", "NNS", "NX", "JJR"}, {"left", "NP", "PRP"}, {"rightdis", "$", "ADJP", "PRN", "FW"}, {"right", "CD"}, {"rightdis", "JJ", "JJS", "RB", "QP", "DT", "WDT", "RBR", "ADVP"}, {"left", "POS"}, rightExceptPunct});
